...
public class CatalogFileProcessorTest {
    ...
    String barcodeAPath  = "/Users/oathkeeper/DEV/mergedcatalog/src/test/resources/inputcsv/barcodeA.csv" ;
    ...
    public void shouldProduceListProductsFromCatalogCsvFile(){
        List<Product> productList = CatalogFileProcessor.getListOfObjectsFromCsvFile(Barcode.class,catalogAPath);
    ...
    public void shouldProduceListBarcodesFromBarcodeCsvFile() {
        List<Barcode> barcodeList = CatalogFileProcessor.getListOfObjectsFromCsvFile(Barcode.class,barcodeAPath);
